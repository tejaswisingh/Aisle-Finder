...
<html lang="en">
  ...
  <head>
    ...
    <link href="http://ec2-52-207-247-54.compute-1.amazonaws.com/CI/Group_project/css/the-big-picture.css" rel="stylesheet">
    ...
    <!-- Navigation -->
      ...
      <?php 
        if(isset($warning)){
          ...
          echo $warning;
          echo '&nbsp;<a href="http://ec2-52-207-247-54.compute-1.amazonaws.com/CI/Group_Project/index.php/Account/login">here</a>';
           ...
           <?php
              echo form_open('account/signup_post');
                ...
                echo '<div class="text-center mb-4" style="margin-bottom: 30px;">
                  <img src="http://ec2-52-207-247-54.compute-1.amazonaws.com/CI/Group_project/Image/newuser.png">  
                </div>';
               ...
               echo '<div class="row">';
                 ...
                 #cancel
                 echo '<div class="col-sm-6">';
                      echo '<a class="btn btn-lg btn-warning btn-block" style="margin: 40px auto;" href="http://ec2-52-207-247-54.compute-1.amazonaws.com/CI/Group_project/">Cancel</a>';
                 echo '</div>';
